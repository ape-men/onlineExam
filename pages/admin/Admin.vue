<template>
    ...
    <el-table-column label="学生ID"   prop="学生ID">
    </el-table-column>
    <el-table-column  label="学生姓名"  prop="学生姓名">
    </el-table-column>
    ...
    <el-table-column label="教师ID"   prop="教师ID">
    </el-table-column>
    <el-table-column  label="教师姓名"  prop="教师姓名">
    </el-table-column>
    <el-table-column  align="right">
      <template slot="header" slot-scope="scope">
        <el-input  v-model="search"  size="mini"  placeholder="输入ID搜索"/>
    ...
    <el-table-column label="课程ID"   prop="课程ID">
    </el-table-column>
    <el-table-column  label="课程名字"  prop="课程名字">
    </el-table-column>
    <el-table-column  align="right">
      <template slot="header" slot-scope="scope">
        <el-input  v-model="search"  size="mini"  placeholder="输入ID搜索"/>
